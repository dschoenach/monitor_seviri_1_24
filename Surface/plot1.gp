...
set title "Frequency  for Visibility (m)\n   Selection: ALL    714 stations\n  Period: 20230114-20230215\n  Used {00,03,...,21} + 00 01 ... 36" 
...
set logscale x
 ...
 plot 'c_00000000_00000000_ALL_ALL_VI_0_REF.scores2' using 2:13 title 'OBS' with linespoints lt 3 lw 2 pt 7,'c_00000000_00000000_ALL_ALL_VI_0_REF.scores2' using 2:14 title 'REF' with linespoints lt 1 lw 2 pt 7,'c_00000000_00000000_ALL_ALL_VI_0_SEV.scores2' using 2:14 title 'SEV' with linespoints lt 2 lw 2 pt 7